						...
						<tbody>
						  ...
						  <thead>
								...
								<tr>
									...
									<td width="100px"><div class="ITEMCD" contenteditable = 'true'><?php echo $val['ITEMCD']; ?></div></td>
									<td width="250px"><div class="ITEMNM1" contenteditable = 'true'><?php echo $val['ITEMNM1']; ?></div></td>
									<td width="80px"><div class="CAQTY" contenteditable = 'true'><?php echo floor($val['CAQTY']); ?></div></td>
									<td width="80px"><div class="IRQTY" contenteditable = 'true'><?php echo floor($val['IRQTY']); ?></div></td>
									<td width="100px"><div class="SALPRC" contenteditable = 'true'><?php echo sprintf("%01.2f",$val['SALPRC']); ?></div></td>
									<td width="100px"><div class="AMT" contenteditable = 'true'><?php echo sprintf("%01.2f",$val['AMT']); ?></div></td>
									<td width="150px"><div class="BIKO1" contenteditable = 'true'><?php echo $val['BIKO1']; ?></div></td>
									<td rowspan="2" width="100px"><button class="btn btn-primary btn-xs add_record">追加</button><button class="btn btn-danger btn-xs del_record">削除</button></td>
							      </tr>
							      <tr>
									<td class="TAXKB">
...
<?php echo $this->Html->script(array('table_scroll')); ?>